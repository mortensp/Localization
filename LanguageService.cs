...
public sealed class LanguageService : INotifyPropertyChanged
{
    ...
    ///   <example>
    ///     var LocalizedString = LanguageService.GetTranslation(typeof(Lex), nameof(Lex.Red));
    ///   </example>
    /// </usages>
    public static string GetTranslation(Type type, string key)
    {
    ...
    /// <usages>
    ///   <example>
    ///     var translations = LanguageService.GetTranslations(typeof(Lex), nameof(Lex.Red));
    ///   </example>
    /// </usages>
    public static IDictionary<CultureInfo, string> GetTranslations(Type type, string key)
    {
        if (type == null)
    ...
    /// <usages>
    ///   <example>
    ///     var translations = LanguageService.GetTranslations(() => Lex.Red);
    ///   </example>
    /// </usages>
    public static IDictionary<CultureInfo, string> GetTranslations(Expression<Func<string>> resourceExpression)
    {
        ...
        return GetTranslations(declaringType, memberName);
    }
    ...
    /// <exception cref="ArgumentNullException"></exception>
    /// <exception cref="InvalidOperationException"></exception>
    public static IDictionary<CultureInfo, string> GetTranslationsValue(Type resourceType, string translatedValue)
    {
        ...
        return GetTranslations(resourceType, foundKey);
    }
    #endregion
